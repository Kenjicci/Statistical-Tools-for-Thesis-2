...
AW_RAW_FILE = 'Step 3 Resources/PR_fastfind_and_uw_raw_metrics.csv' 
# 2. WE NEED THE RAW UW TRIALS
UW_RAW_FILE = 'Step 3 Resources/UW_light_raw_trials.csv'

# Output Files
OUTPUT_CI_FILE = 'Step 4 Resources/PR_CI_Analysis.txt'
OUTPUT_RANGE_FILE = 'Step 4 Resources/PR_Optimal_Range.txt'
