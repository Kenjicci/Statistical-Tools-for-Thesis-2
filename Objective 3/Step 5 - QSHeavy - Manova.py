...
AW_FILE = os.path.join('Step 5 Resources', 'hard_points_raw_trial.csv')
UW_FILE = os.path.join('Step 3 Resources', 'UW_heavy_raw_trial.csv')

# 2. Define Output File
OUTPUT_FILE = 'Step 5 - QSHeavy_MANOVA_Results.txt'
