...
AW_FILE = os.path.join('Step 4 Resources', 'PR_80_raw_trials_reduced.csv')
UW_FILE = os.path.join('Step 4 Resources', 'UW_light_raw_trials.csv')

# 2. Define Output File
OUTPUT_FILE = 'Step 4 - PRLight_MANOVA_Results.txt'
...
def run_manova():
    ...
    print(f"--- Loading Data for Light Tier ---")
    ...
    print(f"Comparison: AW_PR vs UW_Light")
