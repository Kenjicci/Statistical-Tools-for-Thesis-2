...
input_file = os.path.join(script_dir, 'Step 1 Resources/ECM_fastfind_and_uw_raw_metrics.csv')
output_file = os.path.join(script_dir, 'Step 2 Resources/ECM_scaled_metrics.csv')
